...
public:
	...
	uint16_t begin(uint8_t agAddress = LSM9DS1_AG_ADDR(1), uint8_t mAddress = LSM9DS1_M_ADDR(1), i2c_inst_t *i2c_instance = i2c_default); //By default use the default I2C addres, and use Wire port
